...
-  Directly from a zip file: If a zip file is downloaded or received for
   ...
   |image1| icon. Create a shortcut on the Desktop to this executable
   file. To do this,
...
..
   ...
   |image3|\ The Desktop should show the following icon:
...
|                       |                       | considerations        |
+=======================+=======================+=======================+
| |image9| Survey       | A survey is a         | -Data: multiple data  |
...
|                       |                       | 6.0 Template          |
+-----------------------+-----------------------+-----------------------+
| |image10| Geospatial  | Geospatial data       | -Data: location data  |
|                       | usually refers to a   |                       |
...
|                       | system.               |                       |
+-----------------------+-----------------------+-----------------------+
| |image11|\ Time       | Can be a collection   | Data: Multiple data   |
...
|                       |                       | template              |
+-----------------------+-----------------------+-----------------------+
| |image12| Document    | A document is defined | -Data: Does not       |
...
|                       | resource.             |                       |
+-----------------------+-----------------------+-----------------------+
| |image13| Table       | A table depicts data  | -Data: processed and  |
...
|image23|-A shortcut to return to the dashboard panel is provided in the
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   The template manager is accessible by clicking the shortcut |image25|
...
|image29| to the left of the default template.
...
-  Another way to access the datafile import functionality is through
   ...
   the three dots |image35| beside the Dataset node. Clicking this, the
...
|image38|\ Importing multiple datafiles can also be done. Following the
...
~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
   ...
   |image42|\ Clicking this option will allow the user to add rows or
   records under the element. It does not provide the facility to insert
   but appends a row to the bottom of the list.

   |image43| Clicking this option will allow the user to delete the row
   or record. This control will allow for the deletion of the row where
   the cursor is found.

   |image44| Clicking this will move the record where the cursor is
...
-  Calendar: The large downward-pointing arrow will display a calendar
   ...
   |image51| The controls to the right of the box allow the user to move
   forward and backward month-by-month.

   Note: A user must select the date by pressing the |image52| record
   button. This button will record the selected date into the date
   field.

-  Dial the date: Selecting the double arrow control |image53| will
...
Note the arrow at the upper right-hand corner |image60|. Clicking this
...
The user can return to the dashboard by clicking the |image61| button to
...
|image70|\ The “File Description” contains various elements much the
...
Description icon |image71|

or individually by clicking |image72|.
...
Clicking the |image73| icon of the individual datafile, will take the
...
+-----------------------------------+-----------------------------------+
| |image78|                         | New: This allows the user to add  |
...
|image81|\ Categories can be maintained by selecting options from the
...
Data type provides a drop-down box when clicking the |image85| to the
...
|image87|\ Selecting Numeric will also display a “Measure” field. This
...
| to be documented      |
+=======================+=======================+=======================+
| |image102|            | Definition            | This element allows   |
...
|                       |                       | Vocabulary URL.       |
+-----------------------+-----------------------+-----------------------+
| |image103|            | Pre-question Text     | This is text          |
|                       |                       | articulated by the    |
|                       |                       | interview that sets   |
|                       |                       | the scene for the     |
|                       |                       | question.             |
...
|                       |                       | interview.            |
+-----------------------+-----------------------+-----------------------+
| |image104|            | Imputation            | In some cases,        |
...
|                       |                       | variable.             |
+-----------------------+-----------------------+-----------------------+
| |image105|            | Security              | This element provides |
|                       |                       | information on        |
|                       |                       | confidentiality and   |
...
to the left\ |image108|. Clicking that icon will display a screen that
contains the rows and columns of data. This screen is not editable but
only allows the user the ability to browse the data.

|image109|\ The user will also notice an ellipsis to the right of the
...
|image113|\ After creating a variable group note the default value
...
|image115|\ Note the control to the right of the grid:
...
|image121|\ The user will notice the small arrow |image122|\ in the
...
resources. Right clicking on the |image124| will display the choices:
...
|image126|\ Note that the template can be selected by clicking the
pencil icon |image127|\ when at the highest node in the “External
...
and clicking the |image128| .

To add an external resource, click on the |image129| to the right of the
...
|image130|\ Note that all the DCMI elements have been grouped into the
...
the outline of two persons: |image131|. Click this node and note the
...
Note that the link can be checked by clicking the |image132| icon at the
...
|image134|\ Clicking the first icon first icon |image135| will allow the
user to browse the files using Windows Explore and link to the
appropriate document.

The second icon |image136| allows the user to upload the document into
the project.*\*

Changing the title
~~~~~~~~~~~~~~~~~~

|image137|\ When creating an external resource, the Metadata Editor will
...
top most node in the External Resource tree and click the |image139|
icon and selecting the appropriate choice. Selecting the |image140| will
...
|image143|\ The following options are available under the File Item:
...
A. Select a dataset and click on the ‘Variables’ section |image150|.
...
D. The user may now select the new language under the File>Language by
   ...
   |image161|\ Note that the template must also be translated to assure
...
the |image162| in the black control bar. This control has been discussed
...
.. |image0| image:: _images/image1.png
   :width: 4.05208in
   :height: 1.94792in
...
.. |image3| image:: _images/image4.png
   :width: 0.875in
   :height: 0.95833in
.. |image4| image:: _images/image5.png
   :width: 0.23958in
   :height: 0.29487in
.. |image5| image:: _images/image6.png
   :width: 0.21875in
   :height: 0.27083in
.. |image6| image:: _images/image7.png
   :width: 0.21875in
   :height: 0.28125in
.. |image7| image:: _images/image8.png
   :width: 0.21875in
   :height: 0.29167in
.. |image8| image:: _images/image9.png
   :width: 0.27083in
   :height: 0.25in
.. |image9| image:: _images/image5.png
   :width: 0.23958in
   :height: 0.29487in
.. |image10| image:: _images/image6.png
   :width: 0.21875in
   :height: 0.27083in
.. |image11| image:: _images/image7.png
   :width: 0.21875in
   :height: 0.28125in
.. |image12| image:: _images/image8.png
   :width: 0.21875in
   :height: 0.29167in
.. |image13| image:: _images/image9.png
   :width: 0.27083in
   :height: 0.25in
.. |image14| image:: _images/image10.png
   :width: 2.19792in
   :height: 4.10417in
.. |image15| image:: _images/image11.png
   :width: 0.25in
   :height: 0.23958in
.. |image16| image:: _images/image12.png
   :width: 3.55208in
   :height: 2.19792in
.. |image17| image:: _images/image11.png
   :width: 0.25in
   :height: 0.23958in
.. |image18| image:: _images/image13.png
   :width: 0.25in
   :height: 0.28125in
.. |image19| image:: _images/image14.png
   :width: 0.28125in
   :height: 0.32292in
.. |image20| image:: _images/image15.png
   :width: 0.28125in
   :height: 0.29167in
.. |image21| image:: _images/image16.png
   :width: 0.27083in
   :height: 0.29167in
.. |image22| image:: _images/image17.png
   :width: 0.27083in
   :height: 0.29167in
.. |image23| image:: _images/image18.png
   :width: 0.79167in
   :height: 0.29167in
.. |image24| image:: _images/image19.png
   :width: 5.01042in
   :height: 1.95833in
.. |image25| image:: _images/image17.png
   :width: 0.27083in
   :height: 0.29167in
.. |image26| image:: _images/image20.png
   :width: 2.26042in
   :height: 1.375in
.. |image27| image:: _images/image21.png
   :width: 5.97917in
   :height: 0.19514in
.. |image28| image:: _images/image22.png
   :width: 1.64583in
   :height: 4.33333in
.. |image29| image:: _images/image23.png
   :width: 0.26042in
   :height: 0.26042in
.. |image30| image:: _images/image24.png
   :width: 3.98958in
   :height: 1.85417in
.. |image31| image:: _images/image25.png
   :width: 5.97917in
   :height: 1.12222in
.. |image32| image:: _images/image26.png
   :width: 3.75in
   :height: 1.5in
.. |image33| image:: _images/image15.png
   :width: 0.28125in
   :height: 0.29167in
.. |image34| image:: _images/image27.png
   :width: 4.82778in
   :height: 3.39583in
.. |image35| image:: _images/image28.png
   :width: 0.16667in
   :height: 0.16667in
.. |image36| image:: _images/image29.png
   :width: 2.5in
   :height: 0.69792in
.. |image37| image:: _images/image30.png
   :width: 2.26042in
   :height: 1.14583in
.. |image38| image:: _images/image31.png
   :width: 6.5in
   :height: 2.44306in
.. |image39| image:: _images/image32.png
   :width: 2.30208in
   :height: 0.95833in
.. |image40| image:: _images/image33.png
   :width: 2.07292in
   :height: 1.30208in
.. |image41| image:: _images/image34.png
   :width: 6.5in
   :height: 0.74097in
.. |image42| image:: _images/image35.png
   :width: 0.3125in
   :height: 0.22917in
.. |image43| image:: _images/image36.png
   :width: 0.23958in
   :height: 0.20833in
.. |image44| image:: _images/image37.png
   :width: 0.25in
   :height: 0.35417in
.. |image45| image:: _images/image38.png
   :width: 3.83333in
   :height: 0.82756in
.. |image46| image:: _images/image39.png
   :width: 6.375in
   :height: 0.95833in
.. |image47| image:: _images/image40.png
   :width: 5.28125in
   :height: 1.55208in
.. |image48| image:: _images/image41.png
   :width: 4.5625in
   :height: 0.76042in
.. |image49| image:: _images/image42.png
   :width: 2.86458in
   :height: 2.66667in
.. |image50| image:: _images/image43.png
   :width: 2.67708in
   :height: 1.75in
.. |image51| image:: _images/image44.png
   :width: 0.96875in
   :height: 0.40625in
.. |image52| image:: _images/image45.png
   :width: 0.30208in
   :height: 0.33333in
.. |image53| image:: _images/image46.png
   :width: 0.22917in
   :height: 0.34375in
.. |image54| image:: _images/image47.png
   :width: 4.11458in
   :height: 0.90625in
.. |image55| image:: _images/image48.png
   :width: 6.5in
   :height: 0.88333in
.. |image56| image:: _images/image49.png
   :width: 5.94792in
   :height: 4.52083in
.. |image57| image:: _images/image50.png
   :width: 2.92708in
   :height: 0.8125in
.. |image58| image:: _images/image51.png
   :width: 1.26042in
   :height: 0.92708in
.. |image59| image:: _images/image52.png
   :width: 6.5in
   :height: 2.89375in
.. |image60| image:: _images/image53.png
   :width: 0.42708in
   :height: 0.28125in
.. |image61| image:: _images/image54.png
   :width: 0.85417in
   :height: 0.33333in
.. |image62| image:: _images/image55.png
   :width: 5.44792in
   :height: 2.22917in
.. |image63| image:: _images/image56.png
   :width: 5.26042in
   :height: 1.53611in
.. |image64| image:: _images/image57.png
   :width: 2.58333in
   :height: 2.47917in
.. |image65| image:: _images/image58.png
   :width: 5.32292in
   :height: 0.41667in
.. |image66| image:: _images/image59.png
   :width: 1.71875in
   :height: 2.76042in
.. |image67| image:: _images/image60.png
   :width: 5.97917in
   :height: 0.72986in
.. |image68| image:: _images/image61.png
   :width: 2.33333in
   :height: 1.14583in
.. |image69| image:: _images/image62.png
   :width: 3.29167in
   :height: 1.25in
.. |image70| image:: _images/image63.png
   :width: 2.46875in
   :height: 3.09375in
.. |image71| image:: _images/image64.png
   :width: 0.27083in
   :height: 0.21875in
.. |image72| image:: _images/image65.png
   :width: 0.23958in
   :height: 0.19792in
.. |image73| image:: _images/image66.png
   :width: 0.88542in
   :height: 0.1875in
.. |image74| image:: _images/image67.png
   :width: 6.40625in
   :height: 1.63542in
.. |image75| image:: _images/image68.png
   :width: 2.57292in
   :height: 1.625in
.. |image76| image:: _images/image69.png
   :width: 2.875in
   :height: 1.17708in
.. |image77| image:: _images/image70.png
   :width: 0.3125in
   :height: 1.125in
.. |image78| image:: _images/image70.png
   :width: 0.3125in
   :height: 1.125in
.. |image79| image:: _images/image71.png
   :width: 6.09375in
   :height: 6.85417in
.. |image80| image:: _images/image74.png
   :width: 2.59375in
   :height: 2.38542in
.. |image81| image:: _images/image75.png
   :width: 0.30208in
   :height: 0.91667in
.. |image82| image:: _images/image76.png
   :width: 0.1875in
   :height: 0.22917in
.. |image83| image:: _images/image77.png
   :width: 1.70833in
   :height: 4.20833in
.. |image84| image:: _images/image78.png
   :width: 2.63542in
   :height: 2.64583in
.. |image85| image:: _images/image79.png
   :width: 0.16667in
   :height: 0.17708in
.. |image86| image:: _images/image80.png
   :width: 1.36458in
   :height: 1.0625in
.. |image87| image:: _images/image81.png
   :width: 2.8125in
   :height: 1.72917in
.. |image88| image:: _images/image82.png
   :width: 2.76042in
   :height: 0.88542in
.. |image89| image:: _images/image83.png
   :width: 4.82292in
   :height: 1.45833in
.. |image90| image:: _images/image84.png
   :width: 1.14583in
   :height: 3.54167in
.. |image91| image:: _images/image85.png
   :width: 2.64583in
   :height: 0.61458in
.. |image92| image:: _images/image85.png
   :width: 2.64583in
   :height: 0.61458in
.. |image93| image:: _images/image86.png
   :width: 4.32292in
   :height: 1.42708in
.. |image94| image:: _images/image87.png
   :width: 5.82292in
   :height: 2.11944in
.. |image95| image:: _images/image88.png
   :width: 5.71875in
   :height: 1.6875in
.. |image96| image:: _images/image89.png
   :width: 2.80208in
   :height: 1.59375in
.. |image97| image:: _images/image90.png
   :width: 6.5in
   :height: 2.375in
.. |image98| image:: _images/image91.png
   :width: 1.91667in
   :height: 1.14583in
.. |image99| image:: _images/image92.png
   :width: 1.97917in
   :height: 1.0625in
.. |image100| image:: _images/image93.png
   :width: 2.125in
   :height: 0.65625in
.. |image101| image:: _images/image94.png
   :width: 1.8125in
   :height: 0.66667in
.. |image102| image:: _images/image91.png
   :width: 1.91667in
   :height: 1.14583in
.. |image103| image:: _images/image92.png
   :width: 1.97917in
   :height: 1.0625in
.. |image104| image:: _images/image93.png
   :width: 2.125in
   :height: 0.65625in
.. |image105| image:: _images/image94.png
   :width: 1.8125in
   :height: 0.66667in
.. |image106| image:: _images/image95.png
   :width: 0.6875in
   :height: 0.375in
.. |image107| image:: _images/image96.png
   :width: 0.32292in
   :height: 0.96875in
.. |image108| image:: _images/image97.png
   :width: 1.0625in
   :height: 0.26042in
.. |image109| image:: _images/image98.png
   :width: 2.05208in
   :height: 0.4375in
.. |image110| image:: _images/image99.png
   :width: 2.64583in
   :height: 1.83333in
.. |image111| image:: _images/image100.png
   :width: 5.97917in
   :height: 0.74583in
.. |image112| image:: _images/image101.png
   :width: 0.39583in
   :height: 0.69792in
.. |image113| image:: _images/image102.png
   :width: 1.83333in
   :height: 0.65625in
.. |image114| image:: _images/image103.png
   :width: 5.97917in
   :height: 0.64722in
.. |image115| image:: _images/image104.png
   :width: 2.83542in
   :height: 0.89583in
.. |image116| image:: _images/image106.png
   :width: 5.97917in
   :height: 4.75347in
.. |image117| image:: _images/image107.png
   :width: 5.97917in
   :height: 3.76042in
.. |image118| image:: _images/image108.png
   :width: 6.27083in
   :height: 1.66667in
.. |image119| image:: _images/image109.png
   :width: 3.59375in
   :height: 0.85417in
.. |image120| image:: _images/image110.png
   :width: 1.70833in
   :height: 1.61458in
.. |image121| image:: _images/image111.png
   :width: 0.54167in
   :height: 0.95833in
.. |image122| image:: _images/image113.png
   :width: 0.23958in
   :height: 0.25in
.. |image123| image:: _images/image114.png
   :width: 2.38542in
   :height: 1.67708in
.. |image124| image:: _images/image115.png
   :width: 0.1875in
   :height: 0.17708in
.. |image125| image:: _images/image116.png
   :width: 3.44792in
   :height: 1.02083in
.. |image126| image:: _images/image117.png
   :width: 2.6in
   :height: 0.7in
.. |image127| image:: _images/image118.png
   :width: 0.19792in
   :height: 0.25in
.. |image128| image:: _images/image118.png
   :width: 0.19792in
   :height: 0.25in
.. |image129| image:: _images/image115.png
   :width: 0.1875in
   :height: 0.17708in
.. |image130| image:: _images/image119.png
   :width: 2.5625in
   :height: 1.34375in
.. |image131| image:: _images/image120.png
   :width: 1.20833in
   :height: 0.28125in
.. |image132| image:: _images/image121.png
   :width: 0.41667in
   :height: 0.33333in
.. |image133| image:: _images/image122.png
   :width: 6.5in
   :height: 0.92986in
.. |image134| image:: _images/image123.png
   :width: 2.01042in
   :height: 1.16667in
.. |image135| image:: _images/image124.png
   :width: 0.28125in
   :height: 0.29167in
.. |image136| image:: _images/image125.png
   :width: 0.27083in
   :height: 0.26042in
.. |image137| image:: _images/image126.png
   :width: 2.75in
   :height: 1.55208in
.. |image138| image:: _images/image127.png
   :width: 6.5in
   :height: 1.08333in
.. |image139| image:: _images/image128.png
   :width: 0.17708in
   :height: 0.22917in
.. |image140| image:: _images/image128.png
   :width: 0.17708in
   :height: 0.22917in
.. |image141| image:: _images/image129.png
   :width: 3.75in
   :height: 0.83333in
.. |image142| image:: _images/image130.png
   :width: 4.46875in
   :height: 0.30208in
.. |image143| image:: _images/image131.png
   :width: 1.65625in
   :height: 2.60268in
.. |image144| image:: _images/image132.png
   :width: 1.27083in
   :height: 1.3125in
.. |image145| image:: _images/image133.png
   :width: 3.69792in
   :height: 1.125in
.. |image146| image:: _images/image134.png
   :width: 3.25in
   :height: 1.42708in
.. |image147| image:: _images/image135.png
   :width: 1.64583in
   :height: 0.8125in
.. |image148| image:: _images/image136.png
   :width: 3.96875in
   :height: 3.78125in
.. |image149| image:: _images/image137.png
   :width: 5.82292in
   :height: 1.40625in
.. |image150| image:: _images/image138.png
   :width: 0.9375in
   :height: 0.23958in
.. |image151| image:: _images/image139.png
   :width: 5.97917in
   :height: 2.35556in
.. |image152| image:: _images/image140.png
   :width: 5.97917in
   :height: 2.27153in
.. |image153| image:: _images/image141.png
   :width: 5.97917in
   :height: 1.79444in
.. |image154| image:: _images/image142.png
   :width: 3.29167in
   :height: 1.61458in
.. |image155| image:: _images/image143.png
   :width: 4.52083in
   :height: 1.20833in
.. |image156| image:: _images/image144.png
   :width: 2.46875in
   :height: 4.0625in
.. |image157| image:: _images/image145.png
   :width: 4.3125in
   :height: 1.23958in
.. |image158| image:: _images/image146.png
   :width: 6.5in
   :height: 2.02986in
.. |image159| image:: _images/image147.png
   :width: 6.5in
   :height: 1.09167in
.. |image160| image:: _images/image148.png
   :width: 2.63542in
   :height: 0.51042in
.. |image161| image:: _images/image149.png
   :width: 2.17708in
   :height: 2.80208in
.. |image162| image:: _images/image150.png
   :width: 0.28125in
   :height: 0.32292in
.. |image163| image:: _images/image151.png
   :width: 6.5in
   :height: 3.07917in
